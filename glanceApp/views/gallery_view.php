...
<div class="siteWraper">
  ...
  <div class="container"> 
    <!--Recent Profiles Start-->
    	<div class="row">
        	<div class="col-md-9 col-sm-8"><div class="profileWrap">
        <h1>Gallery</h1>
        <!--<span class="totalCount">Total <?php //echo ($gallery_row == 0)?'0':count($gallery_row);?> photos</span>-->
        <div class="actionBox"> <a href="javascript:window.history.back();" title="Block this Person"><span>Go Back</span></a>
          <div class="clear"></div>
        </div>

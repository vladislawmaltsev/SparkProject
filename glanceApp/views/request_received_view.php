        ...
        <div class="requestrecieve">
          <ul class="featuredListing row">
            ...
            <li class="col-md-6">
              ...
              <a href="<?php echo base_url(); ?>friends/accept_friend_request/<?php echo my_encrypt($row->id); ?>" class="chatbtn" title="Accept this Request">Accept</a> <a href="<?php echo base_url(); ?>friends/reject_friend_request/<?php echo my_encrypt($row->id); ?>" class="chatbtn" title="Reject this Person">Reject</a></div>

                ...
                <div class="chatCol"><!--Chat user info-->
                    ...
                    <?php if($rec_row):?>
                        ...
                        <div class="col-md-4 col-sm-4">
                        	<a href="<?php echo base_url(); ?>friends/block_friend/<?php echo my_encrypt($rec_row->id); ?>" title="Block this Person" class="addlist">Block This Person</a> 
                        
                        <?php 
                        if(!$is_freind) {
                        ?>
                        <a href="<?php echo base_url(); ?>friends/send_friend_request/<?php echo my_encrypt($rec_row->id); ?>" title="Send Friend Request" class="addlist">Add Friend</a>
                        <?php
                        }
                        ?>
                        </div>
